...
class FourierCrossAttention(nn.Module):
    def __init__(self, in_channels, out_channels,seq_len_q, seq_len_kv, modes=64, mode_select_method='list',
...
class AutoCorrelationLayer(nn.Module):
    def __init__(self, d_model, n_heads, d_keys=None,
        ...
        self.inner_correlation = FourierCrossAttention(in_channels=d_model,out_channels=d_model,seq_len_q=2000,seq_len_kv=2000)
