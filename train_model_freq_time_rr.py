...
from model_freq_time_rr import FED_s4
...
def main():
    ...
    for i in range(1):
        ...
        trainy = np.load('/home/mininet/cha/orig/bidmc_cross_domain/trainy3_{}.npy'.format(i))
        validx = np.load('/home/mininet/cha/orig/bidmc_cross_domain/validx3_{}.npy'.format(i))[:, :, 0:2]
        validy = np.load('/home/mininet/cha/orig/bidmc_cross_domain/validy3_{}.npy'.format(i))
        testx = np.load('/home/mininet/cha/orig/bidmc_cross_domain/testx3_{}.npy'.format(i))[:, :, 0:2]
        testy = np.load('/home/mininet/cha/orig/bidmc_cross_domain/testy3_{}.npy'.format(i))
        ...
        if args1.is_train == 'yes':  # 训练
            ...
            checkpoint_callback = ModelCheckpoint(
                ...
                mode="min",
                dirpath='./checkpoint',
                filename=str(i) + "_bidmc__best_model_rr",
                save_last=True,
                save_top_k=1,
            ...
            model = PLModel.load_from_checkpoint('./checkpoint/1_bidmc__best_model_rr.ckpt')
            model.eval()
            ...
            # 保存模型预测结果
            with open('result/train_predictions_B_3{}.pkl'.format(i), 'wb') as f:
                pickle.dump(train_predictions, f)
            with open('result/train_reals_B_3{}.pkl'.format(i), 'wb') as f:
            ...
            # 保存模型预测结果
            with open('result/valid_predictions_B_3{}.pkl'.format(i), 'wb') as f:
                pickle.dump(valid_predictions, f)
            with open('result/valid_reals_B_3{}.pkl'.format(i), 'wb') as f:
            ...
            # 保存模型预测结果
            with open('result/test_predictions_B_3{}.pkl'.format(i), 'wb') as f:
                pickle.dump(test_predictions, f)
            with open('result/test_reals_B_3{}.pkl'.format(i), 'wb') as f:
